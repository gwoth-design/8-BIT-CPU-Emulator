...
namespace LogicMain{
    ...
    class Execution{
        ...
        public void Main(){
            string[] input = new string[] {"11110111", "11111111"};
            Console.WriteLine(alu.eightBitSubtractor(input)); //11001010
            //int[] inps = new int[] {0, 1, 0};
            //Console.WriteLine(alu.oneBitSubtractor(inps));
        }
    }
}
